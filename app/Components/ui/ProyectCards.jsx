...
function ProyectCards() {
  return (
    <div className=''>
      <article className="mb-10 w-full md:h-72 flex flex-col md:flex-row rounded-lg border bg-bg1 shadow-md dark:border-none">
        ...
        <div className="p-4 flex flex-col w-full text-texto2">
          ...
          <div className="mt-auto">
            ...
            <div className="gap-4 flex items-center justify-start ">
              <Image src={'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nextjs/nextjs-plain.svg'} alt='nextjs' width={30} height={30} className='transform transition-transform duration-300 ease-in-out hover:scale-105'/>
      ...
      <article className="mb-10 w-full md:h-72 flex flex-col md:flex-row rounded-lg border bg-bg1 shadow-md dark:border-none">
        ...
        <div className="p-4 flex flex-col w-full text-texto2">
          ...
          <p className="text-md flex flex-wrap">Página orientada a la exhibición de proyectos arquitectónicos.</p>
