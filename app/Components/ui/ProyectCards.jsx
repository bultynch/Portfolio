    ...
    <div className=''>
      <article className="mb-4 w-full flex flex-col md:flex-row rounded-lg shadow-md border border-components1 bg-bg1">
        ...
        <div className='w-full h-60 rounded-t-lg md:rounded-l-lg md:rounde-r-none'>
          <div className='w-full h-full bg-yellow-400 rounded-t-lg'></div>
        </div>

        <div className="p-4 flex flex-col text-texto2">
          <h1 className="text-lg font-bold">Proyect Computer Store</h1>
          <p className="mb-2 text-md">E-comerce dedicado a la venta de componentes para computadoras.</p>
          
          <div className='gap-2 text-sm flex items-center justify-start'>

            <div className='flex items-center justify-center'>
              <Link href={'https://github.com/bultynch'}>
                <button className='gap-2 p-1.5 flex items-center bg-[#2b3137] text-texto1 text-sm font-semibold rounded-lg shadow-sm border border-[#24292e] transform transition-transform duration-300 ease-in-out hover:scale-105'>Github<FaGithub className='w-4 h-4 mb-0.5'/></button>
              </Link>
            </div>
            
            <div className='flex items-center justify-center'>
              <Link href={'https://github.com/bultynch/PC-store-react'}>
                <button className='gap-2 p-1.5 flex items-center bg-none text-texto2 text-sm font-semibold rounded-lg shadow-sm border border-texto2 transform transition-transform duration-300 ease-in-out hover:scale-105'>Demo<FaArrowUpRightFromSquare /></button>
              </Link>
            </div>
            
          </div>

          <div className="mt-4 gap-4 flex items-center justify-start ">
      ...
      <article className="mb-4 w-full rounded-lg shadow-md border border-components1 bg-bg1">
        ...
        <div className="p-4 flex flex-col text-texto2">
          <h1 className="text-lg font-bold">Estudio arquitecura</h1>
          <p className="mb-2 text-md">Página orientada a la exposición de proyectos realizados por el estudio 'nombre'.</p>
